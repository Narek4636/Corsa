...
public class NurbCompUtils {
    ...
    public static void animate(ActivityNurbCompBinding binding, int sum1, int sum2){
        ...
        alphaAnimator1.setDuration(PowerCompActivity.DELAY_COMP / 4);
        animator1.setDuration(PowerCompActivity.DELAY_COMP);
        ...
        alphaAnimator2.setDuration(PowerCompActivity.DELAY_COMP / 4);
        animator2.setDuration(PowerCompActivity.DELAY_COMP);
