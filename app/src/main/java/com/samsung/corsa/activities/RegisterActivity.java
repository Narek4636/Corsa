...
//                                ------------------------------ACCURACIES----------------------------------------
                                ...
                                databaseReference.child("users").child(username).child("interiorGuessCorrect").setValue("0");
                                databaseReference.child("users").child(username).child("interiorGuessAll").setValue("0");
...
//                               ---------------------------------------------------------------------------------
                    ...
                    Log.i("TAGAVOR", databaseReference.child("users").child(username).child("rating").toString());
                }
            }
        });
