...
//        carViewModel.deleteAllCars();
        ...
        List<CarEntity> list = new ArrayList<>();
            ...
            carViewModel.addCar(new CarEntity("MERCEDES SLS AMG", 571, 2010, "740", 3.9, Utils.getDrawableBytes(StartActivity.this, R.drawable.sls)));
        ...
        Log.d("Time", "Load time: " + Long.toString(System.currentTimeMillis() - st) + " millis");
    }
}