...
import com.example.corsa.recyclerViewStats.ModeData;
import com.example.corsa.recyclerViewStats.ModeDataAdapter;
import com.example.corsa.recyclerViewBoard.User;
import com.example.corsa.recyclerViewBoard.UserAdapter;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        preferences = getContext().getSharedPreferences(PROFILE_PREFS, MODE_PRIVATE);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        preferences = getContext().getSharedPreferences(PROFILE_PREFS, MODE_PRIVATE);
        preferencesAcc = getContext().getSharedPreferences(ACCURACY_PREFS, MODE_PRIVATE);
